...
* a repository of 96 iCalendar (`*.ics`) test cases organized by error invoked (credits to [BenFort](https://github.com/BenFort) for contributing many of these cases for the harness)
